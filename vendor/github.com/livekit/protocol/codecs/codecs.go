...
var (
	...
	H264MainProfileCodecParameters = webrtc.RTPCodecParameters{
		RTPCodecCapability: webrtc.RTPCodecCapability{
			MimeType:    MimeTypeH264.String(),
			ClockRate:   90000,
			SDPFmtpLine: "level-asymmetry-allowed=1;packetization-mode=1;profile-level-id=4d001e",
		},
		PayloadType: 110,
	}

	UlpfecCodecParameters = webrtc.RTPCodecParameters{
		RTPCodecCapability: webrtc.RTPCodecCapability{
			MimeType:  MimeTypeULPFEC.String(),
			ClockRate: 90000,
		},
		PayloadType: 119,
	}
	...
	FlexFec03CodecParameters = webrtc.RTPCodecParameters{
		RTPCodecCapability: webrtc.RTPCodecCapability{
			MimeType:    MimeTypeFlexFEC03.String(),
			ClockRate:   90000,
	...
	VideoCodecsParameters = []webrtc.RTPCodecParameters{
		...
		H264MainProfileCodecParameters,
		AV1CodecParameters,
		H265CodecParameters,
	}
)
